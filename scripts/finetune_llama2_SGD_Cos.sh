...
python3 finetune.py \
    ...
    --report_to "wandb" \
    --run_name "llama2_7b_SGD_Cosine" \
    --output_dir "./experiments/MAdAiLab/llama2_7b_SGD_Cosine" \
    ...
    --save_total_limit 3 \
    --push_to_hub \
    --hub_model_id "MAdAiLab/llama2_7b_SGD_Cosine" \
    --hub_strategy "checkpoint"

# Define your model name and adapter here
MODEL_NAME="meta-llama/Llama-2-7b-hf"
ADAPTER="MAdAiLab/llama2_7b_SGD_Cosine"
